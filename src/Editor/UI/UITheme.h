...
extern ImVec4 bg0, bg1, bg2, bg3, bg4;
extern ImVec4 hdr, hdrHv, hdrAc;
extern ImVec4 border;
extern ImVec4 text, textDim, textBright;
...
inline ImVec4 colorOf(ComponentColor c)
{
    switch (c)
    {
        case ComponentColor::Yellow:
            return yellow;
        case ComponentColor::Orange:
            return orange;
        case ComponentColor::Red:
            return red;
        case ComponentColor::Magenta:
            return magenta;
        case ComponentColor::Violet:
            return violet;
        case ComponentColor::Blue:
            return blue;
        case ComponentColor::Cyan:
            return cyan;
        case ComponentColor::Green:
            return green;
        case ComponentColor::Neutral:
            break;
    }
    return text;
}
