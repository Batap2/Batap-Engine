...
void Resize(uint32_t width, uint32_t height)
{
    ...
    //            ThrowIfFailed(dx_cctx.swapChain->ResizeBuffers(dx_cctx.bufferCount, clientWidth,
    //            clientHeight,
    ...
    //
    //            dx_cctx.UpdateRenderTargetViews(dx_cctx.device, dx_cctx.swapChain,
    //            dx_cctx.RTVDescriptorHeap); dx_cctx.UpdateFrameBuffers(dx_cctx.device,
    //            dx_cctx.swapChain, dx_cctx.CBV_SRV_UAVDescriptorHeap);
    //        }
}
